<?php
    ...
    $css_array=array('<link rel="stylesheet" type="text/css" href="../assets/booksales.css" />');
    $page_name="customer";
	...
	<div class="collapse navbar-collapse" id="main_nav">
		<ul class="navbar-nav">
          ...
          <h6 style="margin-left:45%; ">Kategoriler</h6>
            ...
            <a style="margin-left:2%; " href="<?php echo $stlink  ?>/pages/booksales.php?tur=<?php  echo $key["id"];  ?>" class="list-group-item list-group-item-action "><?php  echo $a." - ".$key["type"];  ?></a>
          </div>
            <?php
            if ($a<=$key["id"]) {
              $a++;
      ...
      <li class="nav-item active"> <a class="nav-link" href="<?php echo $stlink ?>/pages/booksales.php">Tüm Kitaplar </a> </li>
		</ul>
    <!--
      ...
      <a href="<?php echo $stlink."/pages/bookdetail.php?id=".$key["id"] ?>">
          <div class="card z-index-2 ">
            ...
            <div class="card-body">
              ...
              <a  href="<?php echo $stlink."/transactions/basket.php?musteriid=".$userr["id"]."&kitapid=".$key["id"] ?>">
